...
"}"));
        ...
        labelUsed1 = new QLabel(VSCHddOne);
        labelUsed1->setObjectName(QStringLiteral("labelUsed1"));
        labelUsed1->setMinimumSize(QSize(0, 30));
        labelUsed1->setMaximumSize(QSize(16777215, 30));
        labelUsed1->setStyleSheet(QStringLiteral("font: 12pt \"Arial\";"));

        horizontalLayout->addWidget(labelUsed1);

        labelUsed = new QLabel(VSCHddOne);
        labelUsed->setObjectName(QStringLiteral("labelUsed"));
        labelUsed->setMinimumSize(QSize(0, 30));
        labelUsed->setMaximumSize(QSize(16777215, 30));
        labelUsed->setStyleSheet(QStringLiteral("font: 12pt \"Arial\";"));

        horizontalLayout->addWidget(labelUsed);
    ...
    void retranslateUi(QWidget *VSCHddOne)
    {
        ...
        labelUsed1->setText(QApplication::translate("VSCHddOne", "Video Space:", 0));
        labelUsed->setText(QApplication::translate("VSCHddOne", "0G", 0));
